        ...
        //.wrap("<div class='dataTables_borderWrap' />")   //if you are applying horizontal scrolling (sScrollX)
            .DataTable({
                ...
                'columnDefs': [
                    ...
                    {
                        "orderable": false, "searchable": false, className: 'text-center', "targets": 7, title: '微信', width: 60, render: function (data, type, row, meta) {
                            return data ? '<a href="#"  class="research"  data-item="wx" data-value="{0}">{1}</a>'.format(data, data) : '';
                        }
                    },
                    {
                        "orderable": false, "searchable": false, className: 'text-center', "targets": 8, title: '飞机', width: 80, render: function (data, type, row, meta) {
                    ...
                    {
                        "orderable": false, className: 'text-center', "targets": 10, title: '文件名', width: 80, render: function (data, type, row, meta) {
    ...
    <div class="page-header">
        ...
        <form class="form-search form-inline">
            ...
            <span class="input-icon input-icon-right">
                <input type="text" name="search" id="search" placeholder="全文搜索……" class="nav-search-input" autocomplete="off" style="font-size: 9px;color: black"/>
            </span>
